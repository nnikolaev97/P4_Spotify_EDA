...
class SpotifyImplTreeMapTest {
    ...
    static SortedMap<Playlist, List<Track>> mapInitialized = new TreeMap<>(Comparator.comparing(Playlist::getCreationDate)
            .thenComparing(Playlist::getId)){
        {
            put(playlist1, new ArrayList<>());
        }
    };

    static SortedMap<Playlist, List<Track>> mapInitializedV2 = new TreeMap<>(Comparator.comparing(Playlist::getCreationDate)
            .thenComparing(Playlist::getId)){
        {
            put(playlist1, new ArrayList<>());
    ...
    void getSortedGenres() {
        ...
        //assertTrue(spotify.getSortedGenres(playlist1) instanceof SortedSet, "Return should be a SortedSet"); Muy chueco
