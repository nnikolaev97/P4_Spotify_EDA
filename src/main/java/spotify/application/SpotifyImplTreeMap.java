...
public class SpotifyImplTreeMap implements Spotify {
    //OJO CIUDAO! a la hora de comprobar (contains) si existe una playlist lo realizará
    //mediante el comparador que le hayamos puesto
    private final SortedMap<Playlist, List<Track>> map = new TreeMap<>(Comparator.comparing(Playlist::getCreationDate)
